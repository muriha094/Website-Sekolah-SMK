...
if ($msg == 'LULUS') {
   ...
   <i class="fa-solid fa-circle-check"></i> SELAMAT DENGAN NIS : ' . $nis . ' berhasil LULUS UJIAN
                ...
                <div class="col-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="reset" name="reset" class="btn btn-sm btn-danger me-1 
                            float-end"><i class="fa-solid fa-xmark"></i> Reset</button>
                        </div>
                        <div class="card-body">
