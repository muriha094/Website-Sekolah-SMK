...
<body>
    ...
    <div style="text-align: center">
        ...
        <h2 style="margin-bottom: 15px;">SMK MURIHA</h2>
    </div>
    ...
    <table>
        <thead>
            ...
            <tr>
                ...
                <th style="width: 110px;">Nilai Tertinggi</th>
        ...
        <tfoot>
            <tr>
                <td colspan="7">
                    <hr style="margin-top: 1px; margin-bottom: 2px; margin-left: -5px", size="3", 
                    color="grey">
                    <p>Semarang, <?= date('j F Y')?></p>
                    <p>Dibuat oleh, <b>Dewan Guru SMK MURIHA</b></p>
                </td>
            </tr>
        </tfoot>
    </table>
