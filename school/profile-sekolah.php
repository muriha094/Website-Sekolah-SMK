...
$title = "Profile Sekolah - SMK MURIHA";
        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    <span class="h5"><i class="fa-solid fa-square-pen"></i> Data Sekolah</span>
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="id" value ="<?= $data['id'] ?>">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" style="margin-left: -40px;">
                                        <input type="email" class="form-control border-0 border-bottom" id="email" name="email" value="<?= $data['email'] ?>" placeholder="Masukkan alamat email sekolah " required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" style="margin-left: -40px;">
                                        <textarea name="alamat" id="alamat" cols="30" rows="3" class="form-control" placeholder="Masukkan alamat sekolah " required><?= $data['alamat'] ?></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" style="margin-left: -40px;">
                                        <textarea name="visimisi" id="visimisi" cols="30" rows="3" class="form-control" placeholder="Masukkan visi dan misi sekolah " required><?= $data['visimisi'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
