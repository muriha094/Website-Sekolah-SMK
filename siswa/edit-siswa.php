        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type= "submit" name="update" class="btn btn-primary float-end"><i class="fa-regular fa-floppy-disk"></i> Update</button>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-8">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" style="margin-left: -50px;">
                                    <select name="jurusan" id="jurusan" class="form-select border-0 border-bottom" required>
                                        <?php
                                        $jurusan = ["Kimia Industri", "RPL", "Akuntansi"];
                            ...
                            <div class="mb-3 row">
                                ...
                                <label for="nis" class="col-sm-1 col-form-label">:</label>
                                <div class="col-sm-9" style="margin-left: -50px;">
                                    <textarea name="alamat" id="alamat" cols="30" rows="3" placeholder="Masukkan Alamat Siswa" class= "form-control" required><?= $data['alamat'] ?></textarea>
                                </div>
                            </div>
                        </div>
